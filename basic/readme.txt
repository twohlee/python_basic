...
- 에디터 설정
   ...
   - 왼쪽 메뉴
      ...
      - 플러그인 검색 및 설치
    -파이썬을 설치한 후에  파이썬 파일 한 개를 생성하면 
     - ./basic/p1.py
     - vs code가 해당 파일을 인식하고, python 경로를 잡거나 extension을 설치하라고 유도
     -> vs code 재가동
     -> 왼쪽 메뉴 5번째(extension 항목)항목에서 python 검색
       python, python for vs code, python extension pack 설치 
